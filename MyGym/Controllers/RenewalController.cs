...
namespace MyGym.Controllers
{
    public class RenewalController : Controller
    {
        ...
        public List<SchemeMasterDTO> BindListScheme()
        {
            ...
            foreach (var item in br.GetSchemes())
            {
        ...
        public List<PlanMasterDTO> BindListPlan()
        {
            ...
            foreach (var item in br.GetPlan())
            {
        ...
        public int Pay(RenewalDATA obj)
        {
            try
            {
                ...
                int PDID = Convert.ToInt32(br.Get_PeriodID_byPlan(obj.PlantypeID));
                ...
                int payresult = br.InsertPaymentDetails(PayPD);
